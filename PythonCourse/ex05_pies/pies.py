...
if __name__ == '__main__':
    competitors = get_competitors_list('C:\\Users\\iboit\\OneDrive\\Рабочий стол\\competitors_list.txt')
    results_dict = get_results_dict('C:\\Users\\iboit\\OneDrive\\Рабочий стол\\results.txt')
    filtered_results = filter_results('C:\\Users\\iboit\\OneDrive\\Рабочий стол\\competitors_list.txt',
                                      'C:\\Users\\iboit\\OneDrive\\Рабочий стол\\results.txt')
    sorted_results = sort_results('C:\\Users\\iboit\\OneDrive\\Рабочий стол\\competitors_list.txt',
                                  'C:\\Users\\iboit\\OneDrive\\Рабочий стол\\results.txt')
    ...
    write_results_csv('C:\\Users\\iboit\\OneDrive\\Рабочий стол\\competitors_list.txt',
                      'C:\\Users\\iboit\\OneDrive\\Рабочий стол\\results.txt',
                      'C:\\Users\\iboit\\OneDrive\\Рабочий стол\\correct_results.csv')
