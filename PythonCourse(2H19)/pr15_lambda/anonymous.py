...
def find_the_tallest_person(person_list: list) -> Person:
    ...
    """
    return max(person_list, key=lambda x: x.height)
...
def get_the_rating_product(person_list: list) -> int:
    ...
    :return: product
    """
    return functools.reduce((lambda x, y: x * y), list(map(lambda x: x.rating, person_list)))
...
def sort_by_name_length(person_list: list) -> list:
    ...
    """
    return list(sorted(person_list, key=lambda x: -(len(x.first_name) + len(x.surname))))
...
def get_list_of_increased_ratings(person_list: list, number: int) -> list:
    ...
    """
    return list(map(lambda x: x.increase_rating(number), person_list))
...
def get_people_with_the_lowest_rating(person_list: list) -> list:
    ...
    :return: list of people
    """
    return list(filter(lambda x: x.rating == (min(person_list, key=lambda x: x.rating)).rating, person_list))
...
if __name__ == "__main__":
    ...
    print(get_the_rating_product(list_of_people))
